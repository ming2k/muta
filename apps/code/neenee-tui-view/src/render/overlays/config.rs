...
use crate::render::components::list::{SelectableListPage, draw_selectable_list_page};
use crate::render::components::modal::{ModalHeader, modal_body_width};
use crate::render::components::options::{ChoiceTone, choice_style};
...
pub fn draw_config_modal(
    ...
    let mut body: Vec<Line<'static>> = vec![
        Line::from(Span::styled(
            "Tune neenee-code without leaving the conversation.",
        ...
        body.push(Line::from(vec![
            ...
            Span::styled(
                ...
                Style::default().fg(style.fg).add_modifier(if is_sel {
                    neenee_tui::Modifier::BOLD
                } else {
                    neenee_tui::Modifier::empty()
                }),
            ),
            Span::raw(" ".repeat(gap)),
