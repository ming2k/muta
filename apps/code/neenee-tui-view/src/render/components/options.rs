...
use neenee_tui::{Color, Line, Modifier, Span, Style};
...
pub(in crate::render) enum ChoiceTone {
...
#[derive(Clone, Copy, Debug, Default, PartialEq, Eq)]
pub(in crate::render) enum ChoiceMarker {
...
pub(in crate::render) struct ChoiceStyle {
    pub bg: Color,
    pub fg: Color,
    pub dim: Color,
}
...
pub(in crate::render) fn choice_style(
    tone: ChoiceTone,
    highlighted: bool,
    theme: &Theme,
) -> ChoiceStyle {
...
pub(in crate::render) struct ChoiceOptionRow<'a> {
    pub label: &'a str,
...
pub(in crate::render) fn push_wrapped_styled(
    lines: &mut Vec<Line<'static>>,
    first_prefix: &str,
    continuation_prefix: &str,
    text: &str,
