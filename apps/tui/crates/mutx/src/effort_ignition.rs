...
//! ([`crate::app::App::effort_ignition_epoch`]) so the animation cadence
...
use mutx_engine::{Color, Frame, Modifier, Rect, Span, Style};
...
///
/// This is the codex `Canvas::tint` idea adapted to muta's retained grid:
...
mod tests {
    use super::*;
    use mutx_engine::{Cell, TestTerminal};
    fn theme() -> Theme {
        Theme::default()
    }
