        ...
        match block {
            Block::Text(inline) => {
                ...
                let base = match msg.role {
                    muta_contracts::Role::User => Style::default().fg(theme.user_text()),
                    muta_contracts::Role::System => Style::default().fg(theme.system_text()),
                    muta_contracts::Role::Tool => Style::default().fg(theme.muted()),
