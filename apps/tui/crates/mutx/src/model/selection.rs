...
/// the engine ([`mutx_engine::text`]), the single owner of grapheme/width
/// measurement.
pub use mutx_engine::text::{floor_grapheme_boundary, inclusive_grapheme_end};
...
mod tests {
    ...
    fn expanded_tool_step_copy_uses_semantic_detail() {
        ...
        message.finish_tool_step(
            "call_1",
            "file contents",
            muta_contracts::ToolOutput::text("file contents"),
            42,
        );
