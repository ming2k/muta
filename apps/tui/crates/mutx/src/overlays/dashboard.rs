...
use muta_contracts::{MonitoredSession, SessionHosting, SessionStatus};
use mutx_engine::{
...
mod tests {
    ...
    fn dock_card_badges_a_forked_session_by_kind() {
        ...
        trunk.fork_kind = muta_contracts::SessionForkKind::Trunk;
        ...
        aside.fork_kind = muta_contracts::SessionForkKind::Aside;
        ...
        fork.fork_kind = muta_contracts::SessionForkKind::Fork;
