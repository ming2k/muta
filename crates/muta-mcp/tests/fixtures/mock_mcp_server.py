#!/usr/bin/env python3
"""A tiny, dependency-free MCP stdio server used to validate muta's MCP client.

Speaks the line-delimited JSON-RPC subset muta uses:
  - initialize / notifications/initialized
  - tools/list
  - tools/call

Exposes two trivial tools: `echo` and `add`. Stderr is unused (muta discards
