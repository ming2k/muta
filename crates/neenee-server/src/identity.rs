//! This binary's identity + principal profile.
//!
//! Keep in sync with crates/neenee-cli/src/identity.rs — both binaries are
//! the same product's application layer (ADR-0054).
//!
//! Lives in the application layer (`neenee-server`), NOT in `neenee-transport`.
...
/// What this binary's agent is for.
