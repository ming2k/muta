...
//!
//! Stored in `$XDG_STATE_HOME/neenee/connections.toml` — a program-managed
//! state file, separate from the user-edited `config.toml`.

use neenee_contracts::{ChannelAuth, ClientIdentity};
...
pub struct Connection {
    ...
    /// Client identity to use (Native/neenee, OpenCode, ZCode, Claude Code, etc.).
