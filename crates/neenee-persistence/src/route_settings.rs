...
//! `$XDG_STATE_HOME/neenee/route_settings.json`, separate from
//! `$XDG_CACHE_HOME/neenee/models_discovery.json`, whose contents are all
...
impl RouteSettingsStore {
    ...
    /// Persist atomically under `$XDG_STATE_HOME/neenee/route_settings.json`.
