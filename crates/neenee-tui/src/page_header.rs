...
fn parent_status_label(status: neenee_contracts::ParentStatus) -> &'static str {
    match status {
        neenee_contracts::ParentStatus::Idle => "main idle",
        neenee_contracts::ParentStatus::Running => "main running",
        neenee_contracts::ParentStatus::NeedsApproval => "main needs approval",
        neenee_contracts::ParentStatus::NeedsInput => "main needs input",
        neenee_contracts::ParentStatus::Failed => "main failed",
        neenee_contracts::ParentStatus::Interrupted => "main interrupted",
    }
}
