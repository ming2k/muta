...
/// identity [`neenee_contracts::merge_history`] uses, so a recall finds the
...
pub struct App {
    ...
    pub sticky_rect: Option<neenee_tui_engine::Rect>,
    ...
    pub activity_rect: Option<neenee_tui_engine::Rect>,
    ...
    pub token_ledger: Option<Arc<neenee_contracts::TokenSourceLedger>>,
    ...
    pub token_report: Option<neenee_contracts::TokenSourceReport>,
    ...
    pub provider_delete_rect: Option<neenee_tui_engine::Rect>,
    ...
    pub last_input_rect: neenee_tui_engine::Rect,
    ...
    pub session_detail: Option<neenee_contracts::SessionDetail>,
    ...
    pub pending_input: Option<neenee_contracts::InputRequest>,
    ...
    pub host_sessions: Vec<neenee_contracts::MonitoredSession>,
    ...
    pub custom_color_draft: neenee_contracts::ColorSchemeConfig,
    ...
    pub custom_auth: neenee_contracts::ChannelAuth,
...
impl App {
    ...
    pub fn token_source_report(
        &self,
        session_id: &str,
    ) -> Option<neenee_contracts::TokenSourceReport> {
    ...
    pub fn observe_input_rect(&mut self, rect: neenee_tui_engine::Rect) {
    ...
    pub fn begin_oauth_add(&mut self, template: &ProviderTemplate) {
        ...
        self.oauth_pending_message = match template.auth.default_login_method() {
            Some(neenee_contracts::LoginMethod::Device) => "Requesting device code…".to_string(),
