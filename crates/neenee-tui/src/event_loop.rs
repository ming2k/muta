...
pub(super) struct UiRuntime {
    ...
    /// [`neenee_contracts::AgentResponse::ParentStatus`] and read into [`App::parent_status`]
    ...
    /// emits [`neenee_contracts::AgentResponse::SideViewOpened`] (the loop calls
    ...
    /// [`neenee_contracts::AgentResponse::SessionDetail`] and read into [`App::session_detail`]
    /// for the session-info sub-view.
    pub session_detail: Arc<Mutex<Option<neenee_contracts::SessionDetail>>>,
    ...
    /// listener from [`neenee_contracts::AgentResponse::TokenUsageReport`] and read into
    ...
    pub host_sessions: Arc<Mutex<Vec<neenee_contracts::MonitoredSession>>>,
    ...
    /// while this is `None`.
    pub session_context: Arc<Mutex<Option<neenee_contracts::SessionContextSnapshot>>>,
    ...
    loop {
        ...
        loop {
            ...
            let recognized_command = app
                ...
                .next()
                .map(|first| {
                    neenee_runtime::startup::BuiltinCmd::from_slash(first).is_some()
