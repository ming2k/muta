...
//!
//! The pickers render directly from [`neenee_contracts::ProviderPickerSnapshot`] — one
//! [`neenee_contracts::ProviderPickerRow`] per provider the harness knows how to
...
pub struct ProviderTemplate {
    ...
    pub auth: neenee_contracts::ChannelAuth,
}
...
pub const PROVIDER_TEMPLATES: &[ProviderTemplate] = &[
    ...
    ProviderTemplate {
        ...
        user_agent: None,
        auth: neenee_contracts::ChannelAuth::XaiOAuth,
    },
];
...
mod tests {
    use super::*;
    use neenee_contracts::ProviderPickerRow;
