...
use neenee_contracts::PermissionRequest;

use crate::model::layout::ModalHitMap;
use crate::showcase::common::{self, ShowAction, ShowEvent};
use crate::view::{Theme, draw_permission_sheet};
    ...
    common::run_showcase_events(
        ...
        |f, s| {
            ...
            common::draw_with_chrome(f, &title, hint, &theme, |f| {
                ...
                let rect = neenee_tui_engine::Rect::new(f.area().x, y, f.area().width, h);
