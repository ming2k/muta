...
use crate::tui::model::document::{CodeRange, InlineScan, MathRange, TableAlignment, scan_inline};
...
pub(crate) fn push_table_segment(
...
pub(crate) fn build_table_render(
    headers: &[String],
    rows: &[Vec<String>],
...
pub(crate) fn shrink_column_widths(
    intrinsic: &[usize],
    target: usize,
    min_col: usize,
) -> Vec<usize> {
