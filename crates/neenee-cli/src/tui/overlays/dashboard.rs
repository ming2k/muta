...
fn draw_dock(
    ...
    crate::tui::primitives::draw_scrollbar(
        frame,
        body,
        start_row,
...
fn render_scrollable(
    ...
    crate::tui::primitives::draw_scrollbar(frame, body, *scroll, max_scroll, theme);
}
...
fn render_footer(
    ...
    if keymap_page {
        ...
        crate::tui::primitives::render_modal_footer(
            frame,
            rect,
            &keymap_page_footer_hints(),
            theme,
        );
        return;
    }
...
pub fn draw_session_preview(
    ...
    let area = crate::tui::primitives::centered_rect(62, 72, viewport);
