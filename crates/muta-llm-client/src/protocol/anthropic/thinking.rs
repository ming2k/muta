...
impl ThinkingConfig {
    ...
    pub fn for_model(_model: &muta_contracts::Model) -> Self {
        Self::default()
    }
    ...
    /// open [`muta_contracts::EffortLevel`] ladder, which may carry provider-advertised tiers
    ...
    pub(super) fn resolve_for(self, effort_levels: &[muta_contracts::EffortLevel]) -> Self {
