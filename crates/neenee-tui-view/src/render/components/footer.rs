...
impl FooterHint {
    ...
    pub(in crate::render) const fn with_band(
        key: &'static str,
        label: &'static str,
        band: u8,
    ) -> FooterHintWithBand {
...
#[derive(Clone, Copy)]
pub(in crate::render) struct FooterHintWithBand {
    pub key: &'static str,
    pub label: &'static str,
    pub rank: u8,
}
...
/// use this.
pub(in crate::render) fn render_modal_footer_with_more(
    frame: &mut Frame,
    rect: Rect,
    hints: &[FooterHint],
...
pub(in crate::render) fn modal_footer_text_with_more(
    hints: &[FooterHint],
    extra: &[FooterHintWithBand],
    width: usize,
) -> String {
...
pub(in crate::render) fn keymap_body_lines<'a>(
    hints: &'a [FooterHint],
...
pub(in crate::render) fn keymap_page_footer_hints() -> [FooterHint; 2] {
    [
