...
/// Canonical alias for [`MasterSlot`] under the homogeneous agent architecture (ADR-0183).
pub type AgentSlot = MasterSlot;
...
pub struct MasterSlot {
    ...
    runner_registry: Option<Arc<SubAgentRegistry>>,
...
impl MasterSlot {
    ...
    pub fn with_mesh(
        ...
        runner_registry: Arc<SubAgentRegistry>,
    ) -> Self {
