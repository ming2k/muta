...
use neenee_runtime::UiBridge;
use neenee_runtime::bootstrap::{self, BootstrapParams};
use neenee_runtime::startup::SessionStart;
...
fn params(project_root: std::path::PathBuf, startup: SessionStart) -> BootstrapParams {
    let identity = neenee_contracts::AgentIdentity::new("probe", "autopilot probe");
    BootstrapParams {
        identity: identity.clone(),
        principal: neenee_contracts::PrincipalProfile::with_identity("probe", identity),
