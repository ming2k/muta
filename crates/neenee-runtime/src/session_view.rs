...
///
/// Sent in reply to [`neenee_contracts::AgentRequest::QuerySessionContext`] and re-sent
/// after any mutation ([`neenee_contracts::AgentRequest::RevokePermission`] /
/// [`neenee_contracts::AgentRequest::ToggleTool`]) so the modal always reflects the
/// post-change state.
...
pub fn derive_capabilities(capabilities: &neenee_contracts::ModelCapabilities) -> Vec<String> {
