...
mod tests {
    ...
    fn p_caps(model: &str) -> neenee_contracts::ModelCapabilities {
        neenee_contracts::ModelCapabilities::for_channel(model, None)
    }
    ...
    fn default_constructor_targets_official_base() {
        ...
        assert_eq!(p.endpoint.user_agent(), crate::NEENEE_USER_AGENT);
    }
    ...
    fn omit_thinking_strips_the_whole_thinking_surface() {
        ...
        let capabilities = {
            ...
            caps.thinking = neenee_contracts::thinking::ThinkingSupport::ReasoningContent;
            caps.effort_levels = neenee_contracts::effort::EFFORT_GEMINI_LEVEL
                .iter()
                .copied()
                .map(Into::into)
                .collect();
        ...
        let p = GoogleProvider::new("k".to_string(), "gemini-3.7-flash".to_string())
            ...
            .with_reasoning_effort(Some(neenee_contracts::Effort::High));
    ...
    fn omit_thinking_is_orthogonal_to_non_antigravity_path() {
        ...
        let capabilities = {
            ...
            caps.thinking = neenee_contracts::thinking::ThinkingSupport::ReasoningContent;
            caps.effort_levels = neenee_contracts::effort::EFFORT_GEMINI_BUDGET
                .iter()
                .copied()
                .map(Into::into)
                .collect();
