...
pub type AgentPreset = MasterPreset;
/// Canonical alias for [`MasterPresetId`] under the homogeneous agent model.
pub type AgentPresetId = MasterPresetId;
/// Canonical alias for [`MasterPresetDelegation`] under the homogeneous agent model.
pub type DelegationPolicy = MasterPresetDelegation;

impl MasterPreset {
    /// Preset developer policy (associated constant).
    pub const DEVELOPER: DelegationPolicy = MASTER_DEVELOPER;
    /// Preset code-analyst policy (associated constant).
    pub const CODE_ANALYST: DelegationPolicy = MASTER_CODE_ANALYST;
}

/// Canonical alias for [`MASTER_DEVELOPER`].
pub const PRESET_DEVELOPER: DelegationPolicy = MASTER_DEVELOPER;
/// Canonical alias for [`MASTER_CODE_ANALYST`].
pub const PRESET_CODE_ANALYST: DelegationPolicy = MASTER_CODE_ANALYST;
