...
/// [`WorkspaceRoot`](neenee_contracts::WorkspaceRoot) service on the
/// [`ToolContext`](neenee_contracts::ToolContext), and each path-taking tool
...
pub(crate) fn workspace_base(ctx: &neenee_contracts::tool_registry::ToolContext) -> WorkspaceBase {
