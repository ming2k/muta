...
use neenee_persistence::cache::CachedResource;
...
mod tests {
    ...
    fn npm_mapping_covers_known_packages() {
        ...
        assert_eq!(wire_format_from_npm("@ai-sdk/openai"), WireFormat::OpenAi);
        assert_eq!(wire_format_from_npm("@ai-sdk/google"), WireFormat::Google);
        assert_eq!(
    ...
    fn endpoint_suffix_matches_format() {
        ...
        assert_eq!(endpoint_suffix(WireFormat::OpenAi), "/chat/completions");
    }
    ...
    fn model_override_beats_provider_default() {
        ...
        assert_eq!(model_wire_format(&provider, &glm), WireFormat::OpenAi);
    }
