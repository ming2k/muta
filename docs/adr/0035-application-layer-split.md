...
- **Status:** Superseded by ADR-0073 (the `neenee-quant` application was
  removed) and ADR-0075 (the `neenee-cli` → `neenee-code` rename is reversed,
  restoring the bare `neenee` binary name)
- **Date:** 2026-06-26
