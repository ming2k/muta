...
- **Status:** Accepted (extracted to the independent `netune` library — see
  ADR-0210; the crates below are now `netune-trace`, `netune-http1`,
  `netune` and `netune-probe` in their own lockstep-versioned repository)
- **Date:** 2026-09-08
