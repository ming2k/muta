...
> **Notice**: Superseded by [ADR-0033](../0033-remove-plan-and-verify-workflow.md). This record was
...
`set_autopilot` transitional gate is still in place, the default `PLAN`
