...
- **Date:** 2026-06-22
- **Archived:** 2026-09-08
- **Restored:** 2026-09-08 — restored from git 92645fda^ (INV-TEMP-03 violation repair)

> **Notice**: Superseded by [ADR-0082](../0082-remove-pursuit-stop-gate.md). This record was
...
- [ADR-0082: Remove the pursuit stop-gate and primitive](../0082-remove-pursuit-stop-gate.md)
  — the pursuit primitive was removed; the `pursuits` explanation page no longer exists.
