...
> **Notice**: This decision is obsolete (Superseded — SQLite removed from the project (2026-07)). It was relocated to
> cold storage (`docs/adr/archive/`) on 2026-09-08. It is preserved for historical
> rationale and negative-knowledge audit only.
