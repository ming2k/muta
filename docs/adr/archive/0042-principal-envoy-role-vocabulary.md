...
> **Notice**: Superseded by [ADR-0144](../0144-three-tier-agent-hierarchy-and-tool-pool.md). This record was
...
- **Rewrite the term inside historical ADRs.** Rejected: accepted ADRs are
  immutable records (see [ADR Workflow](../../governance/documentation/profiles/architecture/adr.md)).
