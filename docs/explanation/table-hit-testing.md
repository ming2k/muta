...
[`document.rs`](../../apps/terminal/crates/mutx/src/model/document.rs) detects a
...
[`markdown_table.rs`](../../apps/terminal/crates/mutx/src/markdown_table.rs)
...
[`message_body.rs`](../../apps/terminal/crates/mutx/src/message_body.rs)
...
[`layout.rs`](../../apps/terminal/crates/mutx/src/model/layout.rs) exposes two
...
[`selection.rs`](../../apps/terminal/crates/mutx/src/model/selection.rs) defines:
...
| File | Role |
|------|------|
| [`document.rs`](../../apps/terminal/crates/mutx/src/model/document.rs) | Parses GFM tables into `Block::Table` |
| [`markdown_table.rs`](../../apps/terminal/crates/mutx/src/markdown_table.rs) | Pure layout: column sizing, wrapping, grid assembly, `col_spans` |
