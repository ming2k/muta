...
| Section | Purpose |
|---------|---------|
| [How-to](how-to/) | Task-oriented guides: tools, providers, and configuration |
...
| [Architecture blueprints](architecture/) | Living subsystem blueprints: how a subsystem works today, and its active invariants |
