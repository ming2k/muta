...
`apps/code/neenee-tui-view/src/render/components/modal.rs`:
...
Modal-specific renderers live in `apps/code/neenee-tui-view/src/render/overlays/`
...
`apps/code/neenee-tui-view/src/render/components/`: `modal`, `list`, `scroll`,
...
`apps/code/neenee-tui-view/src/render/primitives.rs`. The chrome-hiding flag is
read by `draw_transcript` in `apps/code/neenee-tui-view/src/render/mod.rs`.
