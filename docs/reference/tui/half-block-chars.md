...
panel background** — no characters, no transition glyphs. (The input box
pads the same way: its four-row layout — breathing row, text, gap row, hint
row — is all solid panel background; see [input box](input-box.md).)
